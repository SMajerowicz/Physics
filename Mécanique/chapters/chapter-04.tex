...
\be
	\mathrm{d}\sigma = 2\pi\rho(\xi)\lvert \dfrac{\mathrm{d}\rho(\xi)}{\mathrm{d}\xi} \rvert \mathrm{d}\xi \label{EQ:18_7}
\ee
...
\be
	\theta_{1} = -2\dfrac{\rho}{m_{1}v_{\infty}^{2}}\int_{\rho}^{\infty}\dfrac{\mathrm{d}U}{\mathrm{d}r}\dfrac{r\mathrm{d}r}{\sqrt{r^{2} - \rho^{2}}}
\ee
...
\be
	\mathrm{d}\sigma = \dfrac{\rho(\theta_{1})}{\theta_{1}}\lvert \dfrac{\mathrm{d}\rho(\theta_{1})}{\mathrm{d}\theta_{1}} \rvert \mathrm{d}\omega \label{EQ:20_4}
\ee
...
\bea
	\dfrac{\partial L}{\partial \vec{v}^{\,2}}2\vec{v}\cdot\vec{\epsilon} & = & \dfrac{\mathrm{d}f(\vec{r},t)}{\mathrm{dt}} \nonumber \\
	\Leftrightarrow 2\dfrac{\partial L}{\partial \vec{v}^{\,2}}\dfrac{\mathrm{d}\vec{r}}{\mathrm{dt}}\cdot\vec{\epsilon} & = & \dfrac{\mathrm{d}f(\vec{r},t)}{\mathrm{dt}} \nonumber \\
	\Leftrightarrow 2\dfrac{\partial L}{\partial \vec{v}^{\,2}}\dfrac{\mathrm{d}(\vec{r}\cdot\vec{\epsilon})}{\mathrm{dt}} & = & \dfrac{\mathrm{d}f(\vec{r},t)}{\mathrm{dt}}
\eea
...
& = & \alpha\vec{v}^{\,2} + 2\alpha\vec{v}\cdot\vec{V} + \alpha\vec{V}^{\,2} \nonumber \\
& = & L + 2\alpha\dfrac{\mathrm{d}\vec{r}}{\mathrm{dt}}\cdot\vec{V} + \alpha\dfrac{\mathrm{dt}}{\mathrm{dt}}\vec{V}^{\,2} \nonumber \\
& = & L + \dfrac{\mathrm{d}}{\mathrm{dt}}\left(2\alpha\vec{r}\cdot\vec{V} + \alpha\vec{V}^{\,2}\mathrm{t}\right)
\eea
...
\bea
	...
	& = & \dfrac{m_{a}}{2}\dfrac{\partial}{\partial\vec{r}_{a}}\left(\dfrac{\mathrm{d}\vec{r}_{a}}{\mathrm{dt}}\right)^{2} - \dfrac{\partial U}{\partial\vec{r}_{a}} \nonumber \\
	& = & \dfrac{m_{a}}{2}\left[\dfrac{\mathrm{d}}{\mathrm{dt}}\left(\dfrac{\partial\vec{r}_{a}}{\partial\vec{r}_{a}}\right)\right]^{2} - \dfrac{\partial U}{\partial\vec{r}_{a}} \nonumber \\
...
\bea
	\vec{F} & = & -\dfrac{\mathrm{d} U(\vec{r})}{\mathrm{d}\vec{r}} \nonumber \\
	\vec{F}.d\vec{r} & = & - \mathrm{d} U(\vec{r}) \nonumber \\

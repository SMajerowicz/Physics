...
et, de facto :
\be
	\int_{\mathrm{t}_{1}}^{\mathrm{t}_{2}} \left(\dfrac{\partial L}{\partial q}\delta q + \dfrac{\partial L}{\partial \dot{q}}\delta \dot{q}\right) \mathrm{dt} = 0
\ee
...
\be
	\delta S = \int_{\mathrm{t}_{1}}^{\mathrm{t}_{2}} \left(\dfrac{\partial L}{\partial q}-\dfrac{\mathrm{d}}{\mathrm{dt}}\left(\dfrac{\partial L}{\partial \dot{q}}\right)\right) \delta q\mathrm{dt}
\ee

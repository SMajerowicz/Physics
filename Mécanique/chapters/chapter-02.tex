...
\be
	\dfrac{{\rm d}L}{{\rm dt}} = \sum_{i=1}^{s}\dfrac{\partial L}{\partial q_{i}}\dfrac{{\rm d} q_{i}}{{\rm dt}} + \sum_{i=1}^{s}\dfrac{\partial L}{\partial \dot{q}_{i}}\dfrac{{\rm d}\dot{q}_{i}}{{\rm dt}} + \dfrac{\partial L}{\partial {\rm t}}
\ee
L'uniformit\'e du temps donne $\dfrac{\partial L}{\partial {\rm t}} = 0$ et en utilisant l'\'equation (\ref{EQ:2_6}), nous avons :
\bea
	\dfrac{{\rm d}L}{{\rm dt}} & = & \sum_{i=1}^{s}\dfrac{{\rm d}}{{\rm dt}}\left(\dfrac{\partial L}{\partial \dot{q}_{i}}\dot{q}_{i}\right) + \sum_{i=1}^{s}\dfrac{\partial L}{\partial \dot{q}_{i}}\ddot{q}_{i} \nonumber \\
	& = & \sum_{i=1}^{s}\dfrac{{\rm d}}{{\rm dt}}\left(\dfrac{\partial L}{\partial \dot{q}_{i}}\dot{q}_{i}\right) \nonumber \\
	0 & = & \dfrac{{\rm d}}{{\rm dt}}\left(\sum_{i=1}^{s}\dfrac{\partial L}{\partial \dot{q}_{i}}\dot{q}_{i} - L\right)
\eea

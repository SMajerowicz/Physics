...
\bea
	\mathrm{d}\sigma & = & \rho(\xi)\lvert \dfrac{\mathrm{d}\rho(\xi)}{\mathrm{d}\xi} \rvert\dfrac{\mathrm{d}\omega}{\sin\xi} = \dfrac{a^{2}n^{2}\sin(\xi/2)}{2}\dfrac{\left(n\cos(\xi/2) - 1\right)\left(n - \cos(\xi/2)\right)}{\left(n^{2} + 1 - 2n\cos(\xi/2)\right)^{2}}\dfrac{\mathrm{d}\omega}{\sin\xi} \nonumber \\
...
\be
	\varphi_{0} = \int_{r_{min}}^{+\infty}{\dfrac{\frac{\rho}{r^{2}}\mathrm{d}r}{\sqrt{1 - \dfrac{\rho^{2}}{r^{2}} - \dfrac{2U(r)}{mv_{\infty}^{2}}}}}
\ee
...
\be
	\varphi_{0} = -\dfrac{\partial}{\partial \rho}\left(\int_{r_{min}}^{\infty}\sqrt{1 - \dfrac{\rho^{2}}{r^{2}} - \dfrac{2U(r)}{mv_{\infty}^{2}}}\mathrm{d}r\right)
\ee
...
\bea
	\varphi_{0}(U(r)) & = & \int_{\rho}^{\infty}\dfrac{\rho\mathrm{d}r}{r^{2}\sqrt{1 - \dfrac{\rho^{2}}{r^{2}}}} - \dfrac{\partial}{\partial\rho}\int_{\rho}^{\infty}\left(\dfrac{\mathrm{\partial}\sqrt{1 - \dfrac{\rho^{2}}{r^{2}} - \dfrac{2U(r)}{mv_{\infty}^{2}}}}{\partial U}\right)_{U(r)}\cdot U(r)\mathrm{d}r \nonumber \\
	& = & \int_{\rho}^{\infty}\dfrac{\rho\mathrm{d}r}{r^{2}\sqrt{1 - \dfrac{\rho^{2}}{r^{2}}}} - \dfrac{-2}{2}\dfrac{1}{mv_{\infty}^{2}\dfrac{\partial}{\partial\rho}}\int_{\rho}^{\infty}\dfrac{U(r)\mathrm{d}r}{\sqrt{1 - \dfrac{\rho^{2}}{r^{2}}}} = I + \dfrac{1}{mv_{\infty}^{2}}\dfrac{\partial}{\partial\rho}J
\eea
...
\bea
	J & = & \int_{\rho}^{\infty}\dfrac{U(r)\mathrm{d}r}{\sqrt{1 - \dfrac{\rho^{2}}{r^{2}}}} = \int_{\rho}^{\infty}\dfrac{U(r)r\mathrm{d}r}{\sqrt{r^{2} - \rho^{2}}} \nonumber \\
	& = & [U(r)\sqrt{r^{2} - \rho^{2}}]_{\rho}^{\infty} - \int_{\rho}^{\infty}\dfrac{\mathrm{d}U(r)}{\mathrm{r}}\sqrt{r^{2} - \rho^{2}}\mathrm{d}r = - \int_{\rho}^{\infty}\dfrac{\mathrm{d}U(r)}{\mathrm{r}}\sqrt{r^{2} - \rho^{2}}\mathrm{d}r
\eea
car :
\be
...
\be
	\varphi_{0} = \dfrac{\pi}{2} - \dfrac{\partial}{\partial\rho}\int_{\rho}^{\infty}\dfrac{\mathrm{d}U(r)}{\mathrm{d}r}\dfrac{\sqrt{r^{2} - \rho^{2}}}{mv_{\infty}^{2}}\mathrm{d}r
\ee
Et comme finalement, $\xi = \pi - 2\varphi_{0}$, et que dans notre cas de petites d\'eviations, $\theta_{1} \approx \xi$ alors :
\bea
	\theta_{1} & = & \pi - \pi + 2\dfrac{\partial}{\partial\rho}\int_{\rho}^{\infty}\dfrac{\mathrm{d}U(r)}{\mathrm{d}r}\dfrac{\sqrt{r^{2} - \rho^{2}}}{mv_{\infty}^{2}}\mathrm{d}r \nonumber \\
	& = & \dfrac{-2\rho}{mv_{\infty}^{2}}\int_{\rho}^{\infty}\dfrac{\mathrm{d}U(r)}{\mathrm{d}r}\dfrac{\mathrm{d}r}{\sqrt{r^{2} - \rho^{2}}}
\eea
...
\be
	\theta_{1} = \dfrac{2\alpha n\rho}{m_{1}v_{\infty}^{2}}\int_{\rho}^{\infty}\dfrac{\mathrm{d}r}{r^{n + 1}\sqrt{r^{2} - \rho^{2}}} = \dfrac{2\alpha n\rho}{m_{1}v_{\infty}^{2}}\int_{\rho}^{\infty}\dfrac{\mathrm{d}r}{r^{n + 2}\sqrt{1 - \dfrac{\rho^{2}}{r^{2}}}}
\ee
En posant :
\be
	\begin{cases}
...
\bea
	\theta_{1} & = & \dfrac{2\alpha n\rho}{m_{1}v_{\infty}^{2}}\int_{\rho}^{\infty}\dfrac{\mathrm{d}r}{r^{n + 1}r\sqrt{1 - \dfrac{\rho^{2}}{r^{2}}}} = \dfrac{2\alpha n\rho}{m_{1}v_{\infty}^{2}}\int_{1}^{0}\dfrac{\frac{-\mathrm{d}u}{2u}}{\dfrac{\rho^{n + 1}}{u^{\dfrac{n + 1}{2}}}\sqrt{1 - u}} \nonumber \\

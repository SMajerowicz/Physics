...
\bea
	...
	\Leftrightarrow m_{1}\vec{v}_{10} + m_{2}\vec{v}_{20} & = & \vec{0} \nonumber
\eea
qui permet d'\'ecrire :
\bea
	m_{1}\lVert \vec{v}_{10} \rVert & = & m_{2}\lVert \vec{v}_{20} \rVert \nonumber \\
	\Leftrightarrow \dfrac{m_{1}}{m_{2}} & = & \dfrac{v_{20}}{v_{10}} \nonumber
\eea
...
\bea
	...
	\Leftrightarrow m_{1}^{2}v_{10}^{2} + m_{1}^{2}v_{10}^{2} + 2 m_{1}^{2}v_{10}^{2}\cos(\theta_{10} + \theta_{20}) & = & 0 \nonumber \\
	\Leftrightarrow \cos(\theta_{10} + \theta_{20}) & = & -1 \nonumber \\
	\Leftrightarrow \theta_{10} + \theta_{20} & = & \pi \nonumber
\eea
...
\bea
	...
	\Leftrightarrow \left(1 + \dfrac{v_{20}}{v_{10}}\right)V & = & \left(\dfrac{1}{\tan\theta_{1}} + \dfrac{1}{\tan\theta_{2}}\right)v_{20}\sin\theta_{10} \nonumber \\
	\Leftrightarrow \sin\theta_{10} & = & V\dfrac{\frac{1}{v_{10}} + \frac{1}{v_{20}}}{\left(\frac{1}{\tan\theta_{1}} + \frac{1}{\tan\theta_{2}}\right)} \nonumber
\eea
...
\bea
	...
	\Leftrightarrow \dfrac{(m_{1} + m_{2})^{2}}{m_{1}^{2}\left(\frac{1}{\tan\theta_{1}} + \frac{1}{\tan\theta_{2}}\right)^{2}} + \dfrac{(m_{1} + m_{2})^{2}}{m_{1}^{2}\left(1 + \frac{\tan\theta_{1}}{\tan\theta_{2}}\right)^{2}} - 2\dfrac{(m_{1} + m_{2})}{m_{1}\left(\frac{1}{\tan\theta_{1}} + \frac{1}{\tan\theta_{2}}\right)} & = & \dfrac{v_{10}^{2}}{V^{2}} - 1 \nonumber \\
	\Leftrightarrow \dfrac{m_{1} + m_{2}}{m_{1}\left(\frac{1}{\tan\theta_{1}} + \frac{1}{\tan\theta_{2}}\right)^{2}} + \dfrac{m_{1} + m_{2}}{m_{1}\left(1 + \frac{\tan\theta_{1}}{\tan\theta_{2}}\right)^{2}} - \dfrac{2}{\left(\frac{1}{\tan\theta_{1}} + \frac{1}{\tan\theta_{2}}\right)} & = & \dfrac{(v_{10}^{2} - V^{2})m_{1}}{(m_{1} + m_{2})V^{2}} \nonumber
\eea
...
Pour \'etablir la distribution des directions des particules r\'esultantes dans le r\'ef\'erentiel <<~l~>>, nous allons repartir de l'\'equation (\ref{EQ:16_6}) qui apporte la solution pour deux domaines diff\'erents.

\subsubsection{$v_{0} > V$}

Dans ce cas, $\theta \in [0;\pi]$ \`a la vue de la figure (\ref{FIG:4_14}), l'\'equation (\ref{EQ:16_6}) s'\'ecrit :
\benn
...
\bea
	...
	\Leftrightarrow m^{2}v^{2} & = & \dfrac{m_{1}^{2}}{m_{2}^{2}}OB^{2} + m_{1}^{2}{v'}_{1}^{2} - 2\dfrac{m_{1}^{2}}{m_{2}}OBv'_{1}\cos\theta_{1} \nonumber \\
	\Leftrightarrow \left(1 - \dfrac{m_{1}^{2}}{m_{2}^{2}}\right)m^{2}v^{2} & = & m_{1}^{2}{v'}_{1}^{2} - 2\dfrac{m_{1}^{2}}{m_{2}}mvv'_{1}\cos\theta_{1} \nonumber \\
	\Leftrightarrow \dfrac{(m_{2} + m_{1})(m_{2} - m_{1})}{m_{2}^{2}}m^{2} & = & m_{1}^{2}\dfrac{v'_{1}}{v}^{2} - 2\dfrac{m_{1}^{2}}{m_{2}}m\dfrac{v'_{1}}{v}\cos\theta_{1} \nonumber \\
	\Leftrightarrow \dfrac{(m_{2} + m_{1})(m_{2} - m_{1})m_{1}^{2}m_{2}^{2}}{m_{2}^{2}(m_{1} + m_{2})} & = & m_{1}^{2}\dfrac{v'_{1}}{v}^{2} - 2\dfrac{m_{1}^{2}}{m_{2}}m\dfrac{v'_{1}}{v}\cos\theta_{1} \nonumber \\
	\Leftrightarrow 0 & = & \left(\dfrac{v'_{1}}{v}\right)^{2} - 2\dfrac{m}{m_{2}}\dfrac{v'_{1}}{v}\cos\theta_{1} + \dfrac{m_{1} - m_{2}}{m_{1} + m_{2}} \nonumber
\eea
...
L'objectif est de calculer la section efficace pour la diffusion de particules par une bille de rayon $a$ parfaitement solide, i.e. $U(r>a) = 0$ et $U(r<a) = \infty$. La figure (\ref{FIG:4_18_EX1}) illustre la trajectoire, \`a savoir que les particules incidentes se meuvent librement avant et apr\`es le choc, qui se compose de deux droites. D'apr\`es la m\^eme figure, nous pouvons \'etablir que :
\bea
...
\benn
	\mathrm{d}\sigma = 2\pi a\cos\dfrac{\xi}{2}\times\bigg\lvert -\dfrac{a}{2}\sin\dfrac{\xi}{2} \bigg\rvert \mathrm{d}\xi = \pi a^{2}\cos\dfrac{\xi}{2}\sin\dfrac{\xi}{2}\mathrm{d}\xi
\eenn
...
Dans ce cas, il nous faut prendre les deux solutions de l'\'equation (\ref{EQ:18_9}). Nous pouvons reprendre celle avec le signe $+$ de la pr\'ec\'edente section et nous calculons la section efficace pour la seconde solution de $\cos\xi$, celle qui s'\'ecrit ainsi :
\benn
	\cos\xi = -\dfrac{m_{1}}{m_{2}}\sin^{2}\theta_{1} - \cos\theta_{1}\sqrt{1 - \dfrac{m_{1}^{2}}{m_{2}^{2}}\sin^{2}\theta_{1}}
\eenn
...
\eea
$\cos\theta_{1}$ n'est pas forc\`ement positif, aussi il nous faut utiliser sa valeur absolue car la section efficace reste une surface et a donc une valeur positive.
...
\eenn
qui exprime la relation entre la vitesse et la longueur pour deux trajectoires diff\'erentes. Nous pouvons ainsi \'ecrire que $\rho\propto v^{-\frac{2}{n}}$ pour des trajectoires semblables. Ceci peut \^etre exprim\'{e} telle que $\rho = v_{\infty}^{-\frac{2}{n}}f(\xi)$ car pour chaque trajectoire semblable, l'angle de d\'eviation est identique. En substituant dans l'\'equation (\ref{EQ:18_6}), nous avons :
\benn
...
Nous allons d\'eterminer la section efficace de particules de masse $m_{1}$ qui <<~chutent~>> sur la surface d'une corps sph\'erique de rayon $R$ et de masse $m_{2} \gg m_{1}$ vers lequel les premi\`eres sont attir\'ees suivant la loi de Newton, voir le paragraphe (\ref{PAR:15}). Le fait que $m_{2} \gg m_{1}$, cela nous permet de supposer que les r\'ef\'erentiels <<~l~>> et <<~c~>> se confondent. Les particules tombent sur la surface du corps central si et seulement si la distance $r_{min}$, i.e. le p\'erih\'elie, de leur trajectoire est inf\'erieure au rayon $R$ de la sph\`ere. Le p\'erih\'elie est d\'efini suivant la relation (\ref{EQ:14_8}) telle que l'\'energie de la particule incident $E$ est \'egale à son \'energie potentielle effective $U_{eff}$. Alors la distance de vis\'ee maximale est telle que $\rho_{max}$ est d\'efinie par $r_{min} = R$ ou encore $U_{eff}(R) = E$, soit :
\bea
...
\ee
Par la suite, nous d\'efinissons les variables suivantes :
\be
	s = \dfrac{1}{r}\text{, }x = \dfrac{1}{\rho^{2}}\text{ et }w = \sqrt{1 - \dfrac{U}{E}} \label{EQ:18_EX7_2}
\ee
L'utilisation des formules (\ref{EQ:18_1}) et (\ref{EQ:18_2}) permet d'\'ecrire :
\benn
...
\eea
car $\xi(\rho \rightarrow \infty) = 0$, i.e. l'angle de d\'eviation devient nul pour une distance de vis\'ee infinie. Nous avons ainsi r\'{e}ussi \`a obtenir la fonction $w(r)$, \'equivalente \`a $U(r)$ pour $r > r_{min}$ et en fonction de l'angle de d\'eviation $\xi$.
...
\eenn
o\`u $n$ repr\'esente un indice de r\'efraction, en faisant une similitude avec l'optique. La figure (\ref{FIG:4_19_EX2}) nous permet d'exprimer l'angle de d\'eviation $\xi$ comme $2(\alpha - \beta)$. Aussi, l'\'equation pr\'ec\'{e}dente se d\'eveloppe en :
\bea
...
\eenn
dans le cas particulier des petites d\'eviations. Tout d'abord, nous remarquons que :
\benn
...
\bea
	...
	& = & \bigintss_{\rho}^{\infty}\dfrac{\rho\mathrm{d}r}{r^{2}\sqrt{1 - \dfrac{\rho^{2}}{r^{2}}}} - \dfrac{-2}{2}\dfrac{1}{mv_{\infty}^{2}}\dfrac{\partial}{\partial\rho}\left(\bigintss_{\rho}^{\infty}\dfrac{U(r)\mathrm{d}r}{\sqrt{1 - \dfrac{\rho^{2}}{r^{2}}}}\right) = I + \dfrac{1}{mv_{\infty}^{2}}\dfrac{\partial}{\partial\rho}J \nonumber
\eea
...
\eenn
Pour l'int\'egrale J, nous r\'ealisons son int\'egration par partie :
\bea
...
\benn
	\varphi_{0} = \dfrac{\pi}{2} - \dfrac{\partial}{\partial\rho}\left(\bigintsss_{\rho}^{\infty}\dfrac{\mathrm{d}U(r)}{\mathrm{d}r}\dfrac{\sqrt{r^{2} - \rho^{2}}}{mv_{\infty}^{2}}\mathrm{d}r\right)
\eenn
Et comme finalement, $\xi = \pi - 2\varphi_{0}$, et que dans notre cas de petites d\'eviations, $\theta_{1} \approx \xi$ alors :
\bea
	\theta_{1} & = & \pi - \pi + 2\dfrac{\partial}{\partial\rho}\left(\bigintsss_{\rho}^{\infty}\dfrac{\mathrm{d}U(r)}{\mathrm{d}r}\dfrac{\sqrt{r^{2} - \rho^{2}}}{mv_{\infty}^{2}}\mathrm{d}r\right) \nonumber \\

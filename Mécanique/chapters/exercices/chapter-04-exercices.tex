...
\bea
	\dfrac{1}{n} & = & \dfrac{\sin\beta}{\sin\alpha} = \dfrac{\sin(\alpha - \xi/2)}{\sin\alpha} = \dfrac{\sin\alpha\cos(-\xi/2) + \cos\alpha\sin(-\xi/2)}{\sin\alpha} = \cos(\xi/2) - \dfrac{\sin(\xi/2)}{\tan\alpha} \nonumber \\
	\Leftrightarrow \cos(\xi/2) - \dfrac{1}{n} & = & \dfrac{\sin(\xi/2)}{\tan\alpha} \Leftrightarrow \tan\alpha = \dfrac{n\sin(\xi/2)}{n\cos(\xi/2) - 1} \nonumber \\
	\Leftrightarrow \dfrac{\sin^{2}\alpha}{1 - \sin^{2}\alpha} & = & \dfrac{n^{2}\sin^{2}(\xi/2)}{n^{2}\cos^{2}(\xi/2) - 2n\cos(\xi/2)}
\eea
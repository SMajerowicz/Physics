...
\bea
	L & = & T - U \nonumber \\
	L & = & \dfrac{ml^{2}}{2}\dot{\varphi}^{2} - mla\alpha\cos(\varphi)\sin(\alpha\mathrm{t})\dot{\varphi} + mgl\cos(\varphi)
\eea
...
\bea
	...
	& = & \dfrac{m}{2}(a^{2}\alpha^{2}\sin^{2}(\alpha\mathrm{t}) + 2al\alpha\sin(\varphi)\sin(\alpha\mathrm{t})\dot{\varphi} + l^{2}\dot{\varphi}^{2})
\eea

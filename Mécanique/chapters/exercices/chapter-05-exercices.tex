...
\bea
	L & = & \dfrac{1}{2}m_{A}(\dot{x}_{1}^{2} + \dot{x}_{3}^{2}) + \dfrac{1}{2}m_{B}\dfrac{m_{A}^{2}}{m_{B}^{2}}(\dot{x}_{1} + \dot{x}_{3})^{2} - \dfrac{k_{l}}{2}\left(x_{1} + \dfrac{m_{A}}{m_{B}}(x_{1} + x_{3})\right)^{2} - \dfrac{k_{l}}{2}\left(x_{3} - + \dfrac{m_{A}}{m_{B}}(x_{1} + x_{3})\right)^{2} \nonumber \\

...
\begin{itemize}
	\item la solution g\'n\'erale sans second membre est $\overline{x_{0}} = ae^{i\omega t + \varphi}$
	\item l'int\'egrale particuli\`ere est $\overline{x_{1}} = be^{(i\beta - \alpha)t}$
\end{itemize}

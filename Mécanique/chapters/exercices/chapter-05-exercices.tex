...
\bea
	...
	& + & \frac{a_{1}\omega_{0}^{2}h}{2}\left(\cos\left(5(\omega_{0} + \epsilon/2)\mathrm{t}\right) + \cos\left(-(\omega_{0} + \epsilon/2)\mathrm{t}\right)\right) + \frac{b_{1}\omega_{0}^{2}h}{2}\left(\sin\left(5(\omega_{0} + \epsilon/2)\mathrm{t}\right) - \sin\left(-(\omega_{0} + \epsilon/2)\mathrm{t}\right)\right) = 0 \nonumber
\eea
...
\bea
	...
	& + & \cos\left(3(\omega_{0} + \epsilon/2)\mathrm{t}\right)\left(-8a_{1}\omega_{0}^{2} + \frac{a_{0}\omega_{0}^{2}h}{2}\right) \nonumber \\
	& + & \sin\left(3(\omega_{0} + \epsilon/2)\mathrm{t}\right)\left(-8b_{1}\omega_{0}^{2} + \frac{b_{0}\omega_{0}^{2}h}{2}\right) = 0 \nonumber
\eea

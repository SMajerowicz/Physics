...
\bea
	\dfrac{\mu}{m_{B}}\left[\dfrac{\mu}{m_{B}}(k_{l}\cos^{2}\alpha + 2k_{t}\sin^{2}\alpha) - m_{A}\omega^{2}\right]\left[k_{l}\sin^{2}\alpha + 2k_{t}\cos^{2}\alpha - m_{A}\omega^{2}\right] - (2k_{l} - k_{t})^{2}\sin^{2}\alpha\cos^{2}\alpha & = & 0 \nonumber \\
\eea

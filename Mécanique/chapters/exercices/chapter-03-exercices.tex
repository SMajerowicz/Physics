...
\bea
	...
	m\sum_{a}\vec{r}_{a} & = & -(M + nm)\vec{R} \Leftrightarrow \vec{R} = \dfrac{-m}{M + nm}\sum_{a}\vec{r}_{a} \nonumber
\eea
...
\bea
	...
	\varphi & = & \dfrac{M_{z}}{l\sqrt{2m}}\bigintss{\dfrac{\mathrm{d}\theta}{\sin^{2}\theta\sqrt{\dfrac{2}{ml^{2}}(E-U_{eff}(\theta))}}} \nonumber
\eea
...
\bea
	...
	\varphi & = & \dfrac{M_{z}}{\sqrt{2m}\sin^{2}\alpha}\bigintsss{\dfrac{\mathrm{d}r}{r^{2}\sqrt{E - U_{eff}(r)}}} \nonumber
\eea

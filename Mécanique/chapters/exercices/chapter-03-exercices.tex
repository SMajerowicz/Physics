...
\benn
	E = \frac{m}{2}\left[\dfrac{\mathrm{d}(l\varphi)}{\mathrm{dt}}\right]^{2} - mgl\cos\varphi = \frac{m}{2}l^{2}\dot{\varphi}^{2} - mgl\cos\varphi
\eenn
...
\benn
	\mathrm{T} = 4\sqrt{\frac{m}{2}}\bigintsss_{0}^{\varphi_{0}}{\dfrac{\mathrm{d}(l\varphi)}{\sqrt{mgl(\cos\varphi - \cos\varphi_{0})}}} = 4\sqrt{\frac{l}{2g}}\bigintsss_{0}^{\varphi_{0}}{\dfrac{\mathrm{d}\varphi}{\sqrt{\cos\varphi - \cos\varphi_{0}}}}
\eenn
Nous notons que :
\bea
	\sin^{2}\frac{\alpha}{2} & = & \left(\dfrac{e^{i\frac{\alpha}{2}} - e^{-i\frac{\alpha}{2}}}{2i}\right)^{2} = -\frac{1}{4}\left(e^{i\alpha} + e^{-i\alpha} - 2e^{i\frac{\alpha}{2}-i\frac{\alpha}{2}}\right) \nonumber \\
	& = & -\frac{1}{4}\left(e^{i\alpha} + e^{-i\alpha} - 2\right) = \frac{1}{2}\left(1-\cos\alpha\right) \nonumber \\
	\Leftrightarrow \cos\alpha & = & 1 - 2\sin^{2}\frac{\alpha}{2} \nonumber
\eea
Cela permet de d\'evelopper la p\'eriode telle que :
\bea
	\mathrm{T} & = & 4\sqrt{\frac{l}{2g}}\bigintsss_{0}^{\varphi_{0}}{\dfrac{\mathrm{d}\varphi}{\sqrt{1-2\sin\frac{\varphi}{2} - 1 + \sin\frac{\varphi_{0}}{2}}}} \nonumber \\
	& = & 4\sqrt{\frac{l}{2g}}\bigintsss_{0}^{\varphi_{0}}{\dfrac{\mathrm{d}\varphi}{\sqrt{2\left(\sin\frac{\varphi_{0}}{2} - \sin\frac{\varphi}{2}\right)}}} = 2\sqrt{\frac{l}{g}}\int_{0}^{\varphi_{0}}{\dfrac{\mathrm{d}\varphi}{\sqrt{\sin\frac{\varphi_{0}}{2} - \sin\frac{\varphi}{2}}}} \nonumber
\eea
...
\bea
	\sin^{2}\xi\sin^{2}\left(\frac{\varphi_{0}}{2}\right) & = & \sin^{2}\left(\frac{\varphi}{2}\right) = 1 - \cos^{2}\left(\frac{\varphi}{2}\right) \nonumber \\
...
\bea
	\sin\xi & = & \dfrac{\sin\left(\frac{\varphi}{2}\right)}{\sin\left(\frac{\varphi_{0}}{2}\right)} \Leftrightarrow \cos\xi\mathrm{d}\xi = \dfrac{\cos\left(\frac{\varphi}{2}\right)}{2\sin\left(\frac{\varphi_{0}}{2}\right)}\mathrm{d}\varphi \nonumber \\
	\Leftrightarrow \mathrm{d}\varphi & = & \dfrac{2\sin\left(\frac{\varphi_{0}}{2}\right)\cos\xi}{\cos\left(\frac{\varphi}{2}\right)}\mathrm{d}\xi = \dfrac{2\sin\left(\frac{\varphi_{0}}{2}\right)\sqrt{1 - \sin^{2}\xi}}{\cos\left(\frac{\varphi}{2}\right)}\mathrm{d}\xi \nonumber \\
	& = & \dfrac{2\sin\left(\frac{\varphi_{0}}{2}\right)\sqrt{1 - \dfrac{\sin^{2}\left(\frac{\varphi}{2}\right)}{\sin^{2}\left(\frac{\varphi_{0}}{2}\right)}}}{\cos\left(\frac{\varphi}{2}\right)}\mathrm{d}\xi = \dfrac{2\sqrt{\sin^{2}\left(\frac{\varphi_{0}}{2}\right) - \sin^{2}\left(\frac{\varphi}{2}\right)}}{\cos\left(\frac{\varphi}{2}\right)}\mathrm{d}\xi \nonumber \\
...
\benn
	K(k) = \bigintsss_{0}^{\frac{\pi}{2}}\dfrac{\mathrm{d}\xi}{\sqrt{1 - k^{2}\sin^{2}\xi}}
\eenn
...
\benn
	K(k) = \dfrac{\pi}{2}\sum_{n=0}^{+\infty}\left[\dfrac{(2n)!}{2^{2n}(n!)^{2}}\right]^{2}k^{2n} = \dfrac{\pi}{2}\left(1 + \left(\dfrac{2}{4 \times 1}\right)^{2}k^{2} + \cdots\right)
\eenn
...
\bea
	\mathrm{T}(E) & = & \sqrt{2m}\bigintsss_{-\left(\frac{E}{A}\right)^{\frac{1}{n}}}^{+\left(\frac{E}{A}\right)^{\frac{1}{n}}}\dfrac{\mathrm{d}x}{\sqrt{E - A\lvert x \rvert^{n}}} = 2\sqrt{2m}\bigintsss_{0}^{+\left(\frac{E}{A}\right)^{\frac{1}{n}}}\dfrac{\mathrm{d}x}{\sqrt{E - Ax^{n}}} \nonumber \\
	& = & 2\sqrt{\dfrac{2m}{E}}\bigintsss_{0}^{+\left(\frac{E}{A}\right)^{\frac{1}{n}}}\dfrac{\mathrm{d}x}{\sqrt{1 - \dfrac{Ax^{n}}{E}}} \nonumber
\eea
...
\be
	\mathrm{T} = 2\sqrt{\dfrac{2m}{E}}\bigintsss_{0}^{1}\left(\dfrac{E}{A}\right)^{\frac{1}{n}}\dfrac{\mathrm{d}y}{\sqrt{1 - y^{n}}} = 2\dfrac{\sqrt{2mE^{\frac{1}{n}-\frac{1}{2}}}}{A^{\frac{1}{n}}}\bigintsss_{0}^{1}\dfrac{\mathrm{d}y}{\sqrt{1 - y^{n}}}
\ee
...
Nous arrivons \`a :
\be
	\mathrm{T} = 2\dfrac{\sqrt{2m}E^{\frac{1}{n}-\frac{1}{2}}}{A^{\frac{1}{n}}}\bigintsss_{0}^{1}\dfrac{u^{\frac{1}{n} - 1}\mathrm{d}u}{n(1-u)^{\frac{1}{2}}} = 2\dfrac{\sqrt{2m}E^{\frac{1}{n}-\frac{1}{2}}}{nA^{\frac{1}{n}}}\bigintsss_{0}^{1}u^{\frac{1}{n} - 1}(1-u)^{\frac{-1}{2}}\mathrm{d}u \label{EQ:APP3_2_a}
\ee
Utilisons ici les int\'egrales d'Euler de premi\`ere esp\`ece, \emph{fonctions Béta}, d\'efinies telles que :
\be
	\mathrm{B}(x,y) = \int_{0}^{1}\mathrm{t}^{x-1}(1-\mathrm{t})^{y-1}\mathrm{dt} = \dfrac{\Gamma(x)\Gamma(y)}{\Gamma(x+y)} \label{EQ:INT_EULER_BETA}
\ee
et celles de seconde esp\`ece, \emph{fonctions Gamma} :
\be
	\Gamma(z) = \int_{0}^{+\infty}\mathrm{t}^{z-1}e^{-\mathrm{t}}\mathrm{dt} \label{EQ:INT_EULER_GAMMA}
\ee
L'\'equation (\ref{EQ:APP3_2_a}) s'\'ecrit alors :
\benn
	\mathrm{T} = 2\dfrac{\sqrt{2m}E^{\frac{1}{n}-\frac{1}{2}}}{nA^{\frac{1}{n}}}\mathrm{B}\left(\frac{1}{n},\frac{1}{2}\right) = 2\dfrac{\sqrt{2m}E^{\frac{1}{n}-\frac{1}{2}}}{nA^{\frac{1}{n}}}\dfrac{\Gamma\left(\frac{1}{n}\right)\Gamma\left(\frac{1}{2}\right)}{\Gamma\left(\frac{1}{n}+\frac{1}{2}\right)}
\eenn
Or $\Gamma(1/2) = \sqrt{\pi}$, nous avons donc finalement :
\be
	\mathrm{T} = 2\dfrac{\sqrt{2\pi m}\Gamma\left(\frac{1}{n}\right)}{nA^{\frac{1}{n}}\Gamma\left(\frac{1}{n}+\frac{1}{2}\right)}E^{\frac{1}{n}-\frac{1}{2}} \label{EQ:11_EX2A_1}
\ee
...
\benn
	\cosh^{2}(\alpha x) = -\dfrac{U_{0}}{E} \Leftrightarrow \alpha x = \pm \arccosh\left(\sqrt{\dfrac{-U_{0}}{E}}\right)
\eenn
...
\bea
	\mathrm{T}(E) & = & \sqrt{2m}\bigints_{-\frac{1}{\alpha}\arccosh\left(\sqrt{\frac{-U_{0}}{E}}\right)}^{\frac{1}{\alpha}\arccosh\left(\sqrt{\frac{-U_{0}}{E}}\right)}\dfrac{\mathrm{d}x}{\sqrt{E + \dfrac{U_{0}}{\cosh^{2}(\alpha x)}}} \nonumber \\
	& = & \sqrt{\dfrac{2m}{\lvert E \rvert}}\bigints_{-\frac{1}{\alpha}\arccosh\left(\sqrt{\frac{-U_{0}}{E}}\right)}^{\frac{1}{\alpha}\arccosh\left(\sqrt{\frac{-U_{0}}{E}}\right)}\dfrac{\mathrm{d}x}{\sqrt{1 + \dfrac{U_{0}}{E\cosh^{2}(\alpha x)}}} \nonumber
\eea
...
et :
\bea
	y^{2} & = & \frac{-U_{0}}{E}\dfrac{1}{\cosh^{2}(\alpha x)} \mathrm{d}y = \sqrt{\frac{-U_{0}}{E}}\dfrac{-\alpha}{\cosh^{2}(\alpha x)}\mathrm{d}x \nonumber \\
	\Leftrightarrow & = & -\alpha\sqrt{\frac{-U_{0}}{E}}\dfrac{E}{-U_{0}}y^{2}\mathrm{d}x \Leftrightarrow \mathrm{d}x = -\sqrt{\frac{-U_{0}}{E}}\dfrac{\mathrm{d}y}{\alpha y^{2}} \nonumber
\eea
La p\'eriode s'\'ecrit alors :
\be
	\mathrm{T}(E) = \sqrt{\dfrac{2m}{\lvert E \rvert}}\int_{-1}^{1}\dfrac{y^{-2}\mathrm{d}y}{\sqrt{1-y^{2}}}\times \dfrac{-1}{\alpha}\sqrt{\dfrac{-U_{0}}{E}} = -\dfrac{2}{\alpha}\sqrt{\dfrac{-U_{0}}{E}}\sqrt{\dfrac{2m}{\lvert E \rvert}}\int_{0}^{1}\dfrac{y^{-2}\mathrm{d}y}{\sqrt{1-y^{2}}}
\ee
...
\bea
	\mathrm{T}(E) & = & -\dfrac{2}{\alpha}\sqrt{\dfrac{-U_{0}}{E}}\sqrt{\dfrac{2m}{\lvert E \rvert}}\int_{0}^{1}\frac{1}{2}\dfrac{u^{-3/2}\mathrm{d}u}{(1-u)^{1/2}} = -\dfrac{1}{\alpha}\sqrt{\dfrac{-U_{0}}{E}}\sqrt{\dfrac{2m}{\lvert E \rvert}} \mathrm{B}\left(-\frac{1}{2},\frac{1}{2}\right) \nonumber \\
...
\bea
	\mathrm{T}(E) & = & \sqrt{2m}\bigintsss_{-\frac{1}{\alpha}\arctan\left(\sqrt{\frac{E}{U_{0}}}\right)}^{\frac{1}{\alpha}\arctan\left(\sqrt{\frac{E}{U_{0}}}\right)}\dfrac{\mathrm{d}x}{\sqrt{E - U_{0}\tan^{2}(\alpha x)}} \nonumber \\
	& = & 2\sqrt{\dfrac{2m}{E}}\bigintsss_{0}^{\frac{1}{\alpha}\arctan\left(\sqrt{\frac{E}{U_{0}}}\right)}\dfrac{\mathrm{d}x}{\sqrt{1 - \frac{U_{0}}{E}\tan^{2}(\alpha x)}} \nonumber
\eea
...
Consid\'erons un syst\`eme ferm\'e compos\'e de $n$ particules de masse $m$ dont chacune a pour rayon vecteur $\vec{R}_{a}$ et d'une particule de masse $M$ qui a pour rayon vecteur $\vec{R}$. Le fonction de Lagrange du syst\`eme s'\'ecrit alors :
\benn
...
\bea
	M\vec{R} + m\sum_{a}\vec{R}_{a} & = & \vec{0} \Leftrightarrow M\vec{R} + m\sum_{a}(\vec{r}_{a} - \vec{R}) = \vec{0} \nonumber \\
	\Leftrightarrow m\sum_{a}\vec{r}_{a} & = & -(M + nm)\vec{R} \Leftrightarrow \vec{R} = \dfrac{-m}{M + nm}\sum_{a}\vec{r}_{a} \nonumber
\eea
...
\begin{figure}[htb!]
	\begin{center}
		\begin{picture}(400,200)(0,0)
			...
			\put(268,85){$\varphi$}
		\end{picture}
		\caption{Vues de face, \`{a} gauche, et du dessus, \`a droite, du pendule sph\'erique}\label{FIG:3_EX1}
	\end{center}
\end{figure}
...
\bea
	E &= & T + U = \dfrac{ml^{2}}{2}(\dot{\theta}^{2} + \sin^{2}\theta\dot{\varphi}^{2}) - mgl\cos\theta \nonumber \\
	& = & \dfrac{ml^{2}}{2}\dot{\theta}^{2} + \dfrac{ml^{2}}{2}\dfrac{\sin^{2}\theta M_{z}^{2}}{m^{2}l^{4}\sin^{4}\theta} - mgl\cos\theta = \dfrac{ml^{2}}{2}\dot{\theta}^{2} + \dfrac{M_{z}^{2}}{2ml^{2}\sin^{2}\theta} - mgl\cos\theta \nonumber
\eea
...
\bea
	...
	\Leftrightarrow \mathrm{t} & = & \int{\dfrac{\mathrm{d}\theta}{\sqrt{\dfrac{2}{ml^{2}}\left(E - U_{eff}(\theta)\right)}}} \nonumber
\eea
...
\bea
	\mathrm{d}\varphi & = & \dfrac{M_{z}\mathrm{d}\theta}{ml^{2}\sin^{2}\theta\sqrt{\dfrac{2}{ml^{2}}(E-U_{eff}(\theta))}} = \dfrac{M_{z}}{l\sqrt{2m}}\dfrac{\mathrm{d}\theta}{\sin^{2}\theta\sqrt{\dfrac{2}{ml^{2}}(E-U_{eff}(\theta))}} \nonumber \\
	\Leftrightarrow \varphi & = & \dfrac{M_{z}}{l\sqrt{2m}}\bigintss{\dfrac{\mathrm{d}\theta}{\sin^{2}\theta\sqrt{\dfrac{2}{ml^{2}}(E-U_{eff}(\theta))}}} \nonumber
\eea
...
\bea
	...
	\Leftrightarrow 0 & = & mgl^{2}\cos^{3}\theta + lE\cos^{2}\theta - mgl^{2}\cos\theta + \dfrac{M_{z}^{2}}{2ml} - lE \nonumber
\eea
est une \'equation du troisi\`eme degr\'e en $\cos\theta$ qui a implicitement deux racines dans l'intervalle $\left]-1;1\right[$. Il existe donc deux angles $\theta_{min}$ et $\theta_{max}$ qui d\'efinissent deux cercles respectifs entre lesquels toute la trajectoire de la particule est comprise.
...
\bea
	E & = & \dfrac{m}{2}(\dot{r}^{2} + r^{2}\sin^{2}\alpha\dot{\varphi}^{2}) + mgr\cos\alpha = \dfrac{m}{2}\dot{r}^{2} + \dfrac{m}{2}r^{2}\sin^{2}\alpha\dfrac{M_{z}^{2}}{m^{2}r^{4}\sin^{4}\alpha} + mgr\cos\alpha \nonumber \\
...
\bea
	...
	\Leftrightarrow \mathrm{dt} & = & \dfrac{\mathrm{d}r}{\sqrt{\dfrac{2}{m}\left(E - U_{eff}(r)\right)}} \Leftrightarrow \mathrm{t} = \int{\dfrac{\mathrm{d}r}{\sqrt{\dfrac{2}{m}\left(E - U_{eff}(r)\right)}}} \nonumber
\eea
avec :
\benn
...
\bea
	...
	\Leftrightarrow \mathrm{d}\varphi & = & \dfrac{M_{z}}{\sqrt{2m}\sin^{2}\alpha}\dfrac{\mathrm{d}r}{r^{2}\sqrt{E - U_{eff}(r)}} \nonumber \\
	\Leftrightarrow \varphi & = & \dfrac{M_{z}}{\sqrt{2m}\sin^{2}\alpha}\bigintsss{\dfrac{\mathrm{d}r}{r^{2}\sqrt{E - U_{eff}(r)}}} \nonumber
\eea
...
\eenn
La coordonn\'ee $x$ n'appara\^it pas dans la fonction de Lagrange et est donc une coordonn\'ee cyclique qui permet de conclure la constance dans le mouvement de l'impulsion g\'en\'eralis\'ee $p_{x}$ qui se d\'efinit ainsi\footnote{Dans ce cas, il n'y a pas de rotation donc l'\'{e}nergie cin\'etique est \'evidemment nulle.} :
\benn
	p_{x} = \dfrac{\partial L}{\partial\dot{x}} = (m_{1} + m_{2})\dot{x} + 2l\dfrac{m_{2}}{2}\dot{\varphi}\cos\varphi = (m_{1} + m_{2})\dot{x} + m_{2}l\dot{\varphi}\cos\varphi = cste
\eenn

Pour le mouvement du centre d'inertie du syst\`eme suivant l'horizontale, il y a $p_{x} = 0$ puisqu'il est au repos et permet d'\'ecrire :
\benn
...
\bea
	...
	& = & \dfrac{m_{2}l^{2}\dot{\varphi}^{2}}{2}\left(1 - \dfrac{m_{2}\cos^{2}\varphi}{(m_{1} + m_{2})}\right) - m_{2}gl\cos\varphi \label{EQ:13_EX3_1}
\eea
...
\bea
	...
	\Leftrightarrow \mathrm{dt} & = & l\sqrt{\dfrac{m_{2}}{2}}\dfrac{\mathrm{d}\varphi}{\sqrt{\dfrac{(m_{1} + m_{2})(E + m_{2}gl\cos\varphi)}{m_{1} + m_{2} - m_{2} + m_{2}\cos^{2}\varphi}}} = l\sqrt{\dfrac{m_{2}}{m_{1} + m_{2}}}\dfrac{m_{1} + m_{2}\cos^{2}\varphi}{\sqrt{E + m_{2}gl\cos\varphi}}\mathrm{d}\varphi \nonumber \\
	\Leftrightarrow \mathrm{t} & = & l\sqrt{\dfrac{m_{2}}{m_{1} + m_{2}}}\bigintsss{\dfrac{m_{1} + m_{2}\cos^{2}\varphi}{\sqrt{E + m_{2}gl\cos\varphi}}\mathrm{d}\varphi} \nonumber
\eea
...
soit :
\bea
	\Leftrightarrow	x_{2} & = & \dfrac{K-m_{2}l\sin\varphi}{(m_{1} + m_{2})} + l\sin\varphi = \dfrac{K}{(m_{1} + m_{2})} + l\left(1 - \dfrac{m_{2}}{(m_{1} + m_{2})}\right)\sin\varphi \nonumber \\
...
\subsection{Repr\'esentation param\'{e}trique pour $U = -\alpha/r$ et $E = 0$}

Nous sommes dans le cas parabolique o\`u $e = 1$ et $p = \dfrac{M^{2}}{m\alpha}$. La relation (\ref{EQ:14_6}) donne dans notre cas pr\'ecis :
\benn
	\mathrm{t} = \bigintss{\dfrac{r\mathrm{d}r}{\sqrt{\dfrac{2\alpha}{m}r - \dfrac{M^{2}}{m}}}}
\eenn
En posant :
\benn
	\begin{cases}
...
nous pouvons \'ecrire :
\bea
	\mathrm{t} & = & \bigintss{\dfrac{\dfrac{M^{2}}{2m\alpha}(1 + \eta^{2})\dfrac{M^{2}}{m\alpha}\eta\mathrm{d}\eta}{\sqrt{\dfrac{2\alpha}{m}\dfrac{M^{2}}{2m\alpha}(1 + \eta^{2}) - \dfrac{M^{2}}{m^{2}}}}} = \bigintss{\dfrac{\dfrac{M^{4}}{2m^{2}\alpha^{2}}(1 + \eta^{2})\eta\mathrm{d}\eta}{\sqrt{\dfrac{M^{2}}{m^{2}}(1 + \eta^{2}) - \dfrac{M^{2}}{m^{2}}}}} \nonumber \\
	& = & \bigintss{\dfrac{\dfrac{M^{4}}{2m^{2}\alpha^{2}}(1 + \eta^{2})\eta\mathrm{d}\eta}{\dfrac{M}{m}\eta}} = \dfrac{M^{3}}{2m\alpha^{2}}\int{(1 + \eta^{2})\mathrm{d}\eta} \nonumber
\eea
or :
\bea
	p & = & \dfrac{M^{2}}{m\alpha} \Leftrightarrow p^{3} =  \dfrac{M^{6}}{m^{3}\alpha^{3}} \Leftrightarrow \dfrac{mp^{3}}{\alpha} = \dfrac{M^{6}}{m^{2}\alpha^{2}} \nonumber \\
...
\bea
	\mathrm{t} & = & \dfrac{1}{2}\sqrt{\dfrac{mp^{3}}{\alpha}}\int{(1 + \eta^{2})\mathrm{d}\eta} \Leftrightarrow \mathrm{t} = \dfrac{1}{2}\sqrt{\dfrac{mp^{3}}{\alpha}}\left(\eta + \dfrac{\eta^{3}}{3}\right) \nonumber \\
...
\bea
	p + r & = & ex \Leftrightarrow x = p - \dfrac{p}{2}(1 + \eta^{2}) \nonumber \\
	\Leftrightarrow x & = & \dfrac{p}{2}(1 + \eta^{2}) \nonumber
\eea
et avec $y^{2} = r^{2} - x^{2}$ :
\bea
	y^{2} & = & \dfrac{p^{2}}{4}(1 + \eta^{4} + 2\eta^{2}) - \dfrac{p^{2}}{4}(1 + \eta^{4} - 2\eta^{2}) = 4\eta^{2}\dfrac{p^{2}}{4} \nonumber \\
...
\bea
	\mathrm{t} & = & \bigintss{\dfrac{\mathrm{d}r}{\sqrt{\dfrac{2}{m}\left(E + \dfrac{\alpha}{r^{2}}\right) - \dfrac{M^{2}}{mr^{2}}}}} = \bigintss{\dfrac{\mathrm{d}r}{\sqrt{\dfrac{2E}{m} + \left(\dfrac{2\alpha}{m} - \dfrac{M^{2}}{m^{2}}\right)\dfrac{1}{r^{2}}}}} = \bigintss{\dfrac{r\mathrm{d}r}{\sqrt{\dfrac{2E}{m}r^{2} + \left(\dfrac{2\alpha}{m} - \dfrac{M^{2}}{m^{2}}\right)}}} \nonumber \\
	& = & \dfrac{m}{2E}\bigintss{\dfrac{r\mathrm{d}r}{\sqrt{r^{2} + \dfrac{\alpha}{E} - \dfrac{M^{2}}{2mE}}}} \nonumber
\eea
En posant :
\benn
	\begin{cases}
...
nous pouvons \'ecrire :
\bea
	\mathrm{t} & = & \dfrac{m}{2E}\int{\dfrac{\mathrm{d}u}{2\sqrt{u}}} = \dfrac{m}{2E}\sqrt{u} = \dfrac{m}{2E}\sqrt{r^{2} + \dfrac{\alpha}{E} - \dfrac{M^{2}}{2mE}} \nonumber \\
...
\be
	\varphi = \bigintss{\dfrac{\dfrac{M}{r^{2}}\mathrm{d}r}{\sqrt{\dfrac{2}{m}\left(E + \dfrac{\alpha}{r^{2}}\right) - \dfrac{M^{2}}{r^{2}}}}} = \bigintss{\dfrac{\dfrac{M}{r^{2}}\mathrm{d}r}{\sqrt{\dfrac{2}{m}E + (2m\alpha - M^{2})\dfrac{1}{r^{2}}}}} \label{EQ:15_EX2_1}
\ee
...
\benn
	\varphi = \dfrac{M}{\sqrt{2mE}}\bigintss{\dfrac{\mathrm{d}r}{r^{2}\sqrt{1 - \dfrac{M^{2} - 2m\alpha}{2mEr^{2}}}}}
\eenn
...
\bea
	\varphi & = & -\dfrac{M}{\sqrt{2mE}}\bigintsss{\dfrac{-\sqrt{2mE}\mathrm{d}u}{\sqrt{M^{2} - 2m\alpha}\sqrt{1 - u^{2}}}} = -\dfrac{M}{\sqrt{M^{2} - 2m\alpha}}\bigintsss{\dfrac{-\mathrm{d}u}{\sqrt{1 - u^{2}}}} \nonumber \\
	& = & \dfrac{1}{\sqrt{1 - \dfrac{2m\alpha}{M^{2}}}}\arccosh\left(-\sqrt{\dfrac{M^{2} - 2m\alpha}{2mE}}\dfrac{1}{r}\right) \nonumber
\eea
ou encore :
\benn
	\dfrac{1}{r} = \dfrac{2mE}{M^{2} - 2m\alpha}\cos\left(-\varphi\sqrt{1 - \dfrac{2m\alpha}{M^{2}}}\right) \Leftrightarrow \dfrac{1}{r} = \dfrac{2mE}{M^{2} - 2m\alpha}\cos\left(\varphi\sqrt{1 - \dfrac{2m\alpha}{M^{2}}}\right)
\eenn
...
\benn
	\varphi = \dfrac{M}{\sqrt{2mE}}\bigintss{\dfrac{\mathrm{d}r}{r^{2}\sqrt{1 + \dfrac{2m\alpha - M^{2}}{2mEr^{2}}}}}
\eenn
En posant :
\benn
	\begin{cases}
...
\be
	\varphi = -\dfrac{M}{\sqrt{2mE}}\bigintss{-\dfrac{\sqrt{\dfrac{2m\alpha - M^{2}}{2mE}}\mathrm{d}u}{\sqrt{1 + u^{2}}}} = \sqrt{\dfrac{M^{2}}{2m\alpha - M^{2}}}\bigintsss{\dfrac{\mathrm{d}u}{\sqrt{1 + u^{2}}}}
\ee
...
\bea
	\varphi & = & \bigintss{\dfrac{\dfrac{M}{r^{2}}\mathrm{d}r}{\sqrt{\dfrac{2}{m}\left(E + \dfrac{\alpha}{r^{2}}\right) - \dfrac{M^{2}}{r^{2}}}}} = \bigintss{\dfrac{\dfrac{M}{r^{2}}\mathrm{d}r}{\sqrt{-\dfrac{2}{m}\lvert E \rvert + (2m\alpha - M^{2})\dfrac{1}{r^{2}}}}} \nonumber \\
	& = & \dfrac{M}{2m\lvert E \rvert}\bigintss{\dfrac{\mathrm{d}r}{\dfrac{1}{r^{2}}\left(\dfrac{2m\alpha - M^{2}}{2m\lvert E \rvert}\right) - 1}} \nonumber
\eea
...
La variable $\varphi$ devient avec l'apparition d'un signe n\'egatif car $u$ est inversement proportionnel \`a $r$ donc nous inversons les bornes de l'int\'egrale :
\benn
	\varphi = -\dfrac{M}{\sqrt{2mE}}\bigintss{-\dfrac{\sqrt{\dfrac{2m\alpha - M^{2}}{2m\lvert E \rvert}}\mathrm{d}u}{\sqrt{u^{2} - 1}}} = \sqrt{\dfrac{M^{2}}{2m\alpha - M^{2}}}\bigintsss{\dfrac{\mathrm{d}u}{\sqrt{u^{2} - 1}}}
\eenn
...
Dans les deux derniers cas \'etudi\'es, il est int\'eressant de noter que quand $\varphi \rightarrow +\infty$ alors $\frac{1}{r} \rightarrow +\infty$ et donc $r \rightarrow 0$. En s'appuyant sur l'\'equation (\ref{EQ:15_EX2_2}), le temps mis par la particule pour chuter de $r$ \`a 0 vaut :
\benn
	\Delta\mathrm{t} = \mathrm{t}(r) - \mathrm{t}(0) = \dfrac{m}{2}\dfrac{1}{E}\left(\sqrt{Er^{2} + \alpha - \dfrac{M^{2}}{2m}} - \sqrt{\alpha - \dfrac{M^{2}}{2m}}\right)
\eenn
...
\benn
	\Delta\varphi = 2\bigintsss_{r_{min}}^{r_{max}}{\dfrac{\frac{M}{r^{2}}\mathrm{d}r}{\sqrt{2m(E - U(r)) - \frac{M^{2}}{r^{2}}}}}
\eenn
En remarquant que :
\benn
...
alors :
\bea
	\Delta\varphi & = & -2\dfrac{\partial}{\partial M}\left(\bigintsss_{r_{min}}^{r_{max}}{\sqrt{2m(E - U(r)) - \frac{M^{2}}{r^{2}}}\mathrm{d}r}\right) \nonumber \\
	& = & -2\dfrac{\partial}{\partial M}\left(\bigintsss_{r_{min}}^{r_{max}}{\sqrt{2m(E + \dfrac{\alpha}{r} - \delta U) - \frac{M^{2}}{r^{2}}}\mathrm{d}r}\right) \nonumber
\eea
R\'ealisons le d\'eveloppement limit\'e de $\Delta\varphi$ \`a l'ordre 0 :
\benn
	\Delta\varphi_{0} = -2\dfrac{\partial}{\partial M}\left(\bigintsss_{r_{min}}^{r_{max}}{\sqrt{2m(E + \dfrac{\alpha}{r}) - \frac{M^{2}}{r^{2}}}\mathrm{d}r}\right)
\eenn
...
\bea
	r_{min} & = & \dfrac{p}{1 + e} \Leftrightarrow 1 + e = 1 + e\cos\varphi_{min} \nonumber \\
	\Leftrightarrow \cos\varphi_{min} & = & 1 \Rightarrow \varphi_{min} = 0 \nonumber \\
	r_{max} & = & \dfrac{p}{1 - e} \Leftrightarrow 1 - e = 1 + e\cos\varphi_{max} \nonumber \\
...
\bea
	\Delta\varphi_{1} & = & -2\dfrac{\partial}{\partial M}\left(\bigintss_{r_{min}}^{r_{max}}{\dfrac{-\dfrac{1}{2}2m\delta U\mathrm{d}r}{\sqrt{2m\left(E + \dfrac{\alpha}{r}\right) - \frac{M^{2}}{r^{2}}}}}\right) \nonumber \\
	& = & \dfrac{\partial}{\partial M}\left(\bigintss_{r_{min}}^{r_{max}}{\dfrac{2m\delta U\mathrm{d}r}{\sqrt{2m(E + \dfrac{\alpha}{r}) - \frac{M^{2}}{r^{2}}}}}\right) \nonumber
\eea
...
\bea
	\delta\varphi & = & \dfrac{\partial}{\partial M}\left(\int_{0}^{\pi}{\delta U\dfrac{2mr^{2}}{M}\mathrm{d}\varphi}\right) = \dfrac{\partial}{\partial M}\left(\dfrac{2mr^{2}}{M}\int_{0}^{\pi}{r^{2}\delta U\mathrm{d}\varphi}\right) = \dfrac{\partial}{\partial M}\left(\dfrac{2mr^{2}}{M}r^{2}\delta U\pi\right) \nonumber \\
...
\bea
	\delta\varphi & = & \dfrac{\partial}{\partial M}\left(\dfrac{2m}{M}\int_{0}^{\pi}{\dfrac{\gamma}{r}\mathrm{d}\varphi}\right) = \dfrac{\partial}{\partial M}\left(\dfrac{2m}{M}\int_{0}^{\pi}{\dfrac{\gamma}{p}(1 + e\cos\varphi)\mathrm{d}\varphi}\right) \nonumber \\
	& = & \dfrac{\partial}{\partial M}\left(\dfrac{2m}{M}\dfrac{\gamma\pi}{p}\right) = \dfrac{\partial}{\partial M}\left(\dfrac{2m^{2}\gamma\alpha\pi}{M^{3}}\right) = -\dfrac{6m^{2}\gamma\alpha\pi}{M^{4}} = -\dfrac{6m^{2}\gamma\alpha\pi}{m^{2}\alpha^{2}p^{2}} \nonumber \\

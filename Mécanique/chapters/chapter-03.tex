...
\bea
	\dfrac{\mathrm{d}U_{eff}(r)}{\mathrm{d}r} & = & 0 \nonumber \\
	\Leftrightarrow \dfrac{\alpha}{r^{2}} - \dfrac{2M^{2}}{2mr^{3}} & = & 0 \nonumber \\
	\Leftrightarrow \dfrac{\alpha}{r^{2}} & = & \dfrac{M^{2}}{mr^{3}} \nonumber \\
	\Leftrightarrow r & = & \dfrac{M^{2}}{\alpha m}
\eea
...
\be
	\varphi = \int{\dfrac{\dfrac{M}{r^{2}}\mathrm{d}r}{\sqrt{2m\left(E + \dfrac{\alpha}{r}\right) - \dfrac{M^{2}}{r^{2}}}}}
\ee
...
\bea
	\varphi & = & \int{\dfrac{-\mathrm{d}u}{\sqrt{2m\left(E + \dfrac{\alpha u}{M} + \dfrac{m\alpha^{2}}{M^{2}}\right) - \left(u + \dfrac{m\alpha}{M}\right)^{2}}}} \nonumber \\
	& = & \int{\dfrac{-\mathrm{d}u}{\sqrt{2mE + 2m\dfrac{\alpha u}{M} + 2\dfrac{m^{2}\alpha^{2}}{M^{2}} - u^{2} - \dfrac{m^{2}\alpha^{2}}{M^{2}} - 2u\dfrac{\alpha m}{M}}}} \nonumber \\
	& = & \int{\dfrac{-\mathrm{d}u}{\sqrt{2mE + \dfrac{m^{2}\alpha^{2}}{M^{2}} - u^{2}}}} \nonumber \\
	& = & \dfrac{1}{\sqrt{2mE + \dfrac{m^{2}\alpha^{2}}{M^{2}}}}\int{\dfrac{-\mathrm{d}u}{\sqrt{1 - \dfrac{u^{2}}{2mE + \dfrac{m^{2}\alpha^{2}}{M^{2}}}}}}
\eea
...
Nous obtenons :
\bea
	\varphi & = & \int{\dfrac{-\mathrm{d}v}{\sqrt{1 - v^{2}}}} \nonumber \\
	& = & \arccos v + cste \nonumber \\
\eea
Soit finalement :
\be
...
\bea
	...
	& = & \dfrac{\dfrac{M}{r} - \dfrac{m\alpha}{M}}{\dfrac{m\alpha}{M}\sqrt{\dfrac{2mEM^{2}}{m^{2}\alpha^{2}}} + 1} \nonumber \\
...
\bea
	a = \dfrac{p}{1 - e^{2}} & = & \dfrac{M^{2}}{m\alpha\left(1 - 1 - \dfrac{2EM^{2}}{m\alpha^{2}}\right)} \nonumber \\
	& = & \dfrac{M^{2}}{\dfrac{2\lvert E \rvert M^{2}}{m\alpha}} \nonumber \\
	& = & \dfrac{\alpha}{2\lvert E \rvert} \label{EQ:15_6a}
\eea
et le petit demi-axe $b$ :
\bea
	b = \dfrac{p}{\sqrt{1 - e^{2}}} & = & \dfrac{M^{2}}{m\alpha\sqrt{1 - 1 - \dfrac{2EM^{2}}{m\alpha^{2}}}} \nonumber \\
	& = & \dfrac{M^{2}}{m\alpha\sqrt{\dfrac{2\lvert E \rvert M^{2}}{m\alpha^{2}}}} \nonumber \\
...
\bea
	Er^{2} & = & -\alpha r + \dfrac{M^{2}}{2m} \nonumber \\
	\Leftrightarrow Er^{2} + \alpha r - \dfrac{M^{2}}{2m} & = & 0
\eea
...
\bea
	M & = & 2m\dot{f} \nonumber \\
	\Leftrightarrow \int_{0}^{T} M\mathrm{dt} & = & 2m\int_{0}^{T} \dot{f}\mathrm{dt} \nonumber \\
	\Leftrightarrow MT & = & 2m\int_{0}^{T} \mathrm{d}f \nonumber \\
...
\bea
	\mathrm{t} & = & \int{\dfrac{\mathrm{d}r}{\sqrt{\dfrac{2}{m}\left(E - U(r)\right) - \dfrac{M^{2}}{m^{2}r^{2}}}}} \nonumber \\
	& = & \sqrt{\dfrac{m}{2\lvert E \rvert}}\int{\dfrac{\mathrm{d}r}{\sqrt{-1 + \dfrac{\alpha}{r\lvert E \rvert} - \dfrac{M^{2}}{2m\lvert E \rvert r^{2}}}}} \nonumber \\
	& = & \sqrt{\dfrac{m}{2\lvert E \rvert}}\int{\dfrac{r\mathrm{d}r}{\sqrt{-r^{2} + \dfrac{\alpha r}{\lvert E \rvert} - \dfrac{M^{2}}{2m\lvert E \rvert}}}}
\eea
...
\be
	\mathrm{t} = \sqrt{\dfrac{ma}{\alpha}}\int{\dfrac{r\mathrm{d}r}{\sqrt{a^{2}e^{2} - (r - a)^{2}}}}
\ee
En posant :
\be
	\begin{cases}
...
nous pouvons \'ecrire :
\bea
	\mathrm{t} & = & \sqrt{\dfrac{ma}{\alpha}}\int{\dfrac{a^{2}(1 - e\cos\xi)e\sin\xi\mathrm{d}\xi}{a^{2}e^{2} - a^{2}e^{2}\cos^{2}\xi}} \nonumber \\
	& = & \sqrt{\dfrac{ma}{\alpha}}\int{\dfrac{a^{2}(1 - e\cos\xi)e\sin\xi\mathrm{d}\xi}{a^{2}e^{2}(1 - \cos^{2}\xi)}} \nonumber \\
	& = & \sqrt{\dfrac{ma}{\alpha}}\dfrac{a^{2}e}{ae}\int{(1 - e\cos\xi)\mathrm{d}\xi} \nonumber \\
	& = & \sqrt{\dfrac{ma^{3}}{\alpha}}\int{(1 - e\cos\xi)\mathrm{d}\xi} \nonumber \\
...
\bea
	\mathrm{t} & = & \int{\dfrac{\mathrm{d}r}{\sqrt{\dfrac{2}{m}\left(E + \dfrac{\alpha}{r}\right) - \dfrac{M^{2}}{m^{2}r^{2}}}}} \nonumber \\
	& = & \sqrt{\dfrac{m}{2E}}\int{\dfrac{r\mathrm{d}r}{\sqrt{r^{2} + \dfrac{\alpha}{E}r - \dfrac{M^{2}}{2mE}}}}
\eea
...
\bea
	\mathrm{t} & = & \sqrt{\dfrac{ma}{\alpha}}\int{\dfrac{r\mathrm{d}r}{\sqrt{-\left(r^{2} + \dfrac{\alpha}{E}r - \dfrac{M^{2}}{2mE}\right)}}} \nonumber \\
	& = & \sqrt{\dfrac{ma}{\alpha}}\int{\dfrac{r\mathrm{d}r}{\sqrt{(r + a)^{2} - a^{2}e^{2}}}} \nonumber \\
	& = & \sqrt{\dfrac{ma}{\alpha}}\int{\dfrac{a(e\cosh\xi - 1)ae\sin\xi\mathrm{d}\xi}{\sqrt{\left(a(e\cosh\xi - 1) + a\right)^{2} - a^{2}e^{2}}}} \nonumber \\
	& = & \sqrt{\dfrac{ma}{\alpha}}\int{\dfrac{a(e\cosh\xi - 1)ae\sin\xi\mathrm{d}\xi}{\sqrt{a^{2}e^{2}\cosh^{2}\xi - a^{2}e^{2}}}} \nonumber \\
	& = & \sqrt{\dfrac{ma}{\alpha}}\int{\dfrac{a(e\cosh\xi - 1)ae\sin\xi\mathrm{d}\xi}{ae\sqrt{\cosh^{2}\xi - 1}}} \nonumber \\
	& = & \sqrt{\dfrac{ma}{\alpha}}\dfrac{a^{2}e}{ae}\int{(e\cosh\xi - 1)\mathrm{d}\xi} \nonumber \\
...
\be
	\varphi = \int{\dfrac{\frac{M}{r^{2}}\mathrm{d}r}{\sqrt{2m\left(E + \dfrac{\alpha}{r}\right) - \frac{M^{2}}{r^{2}}}}}
\ee
...
\bea
	\mathrm{t} & = & \int{\dfrac{\mathrm{d}r}{\sqrt{\dfrac{2}{m}\left(E - \dfrac{\alpha}{r}\right) - \dfrac{M^{2}}{m^{2}r^{2}}}}} \nonumber \\
	& = & \sqrt{\dfrac{ma}{\alpha}}\int{\dfrac{r\mathrm{d}r}{\sqrt{r^{2} - \dfrac{\alpha}{E}r - \dfrac{M^{2}}{2mE}}}}
\eea
En remarquant que :
\bea
...
\be
	\mathrm{t} = \sqrt{\dfrac{ma}{\alpha}}\int{\dfrac{r\mathrm{d}r}{\sqrt{(r - a)^{2} - a^{2}e^{e}}}}
\ee
En posant :
\be
	\begin{cases}
...
nous prolongeons en :
\bea
	\mathrm{t} & = & \sqrt{\dfrac{ma}{\alpha}}\int{\dfrac{a(e\cosh\xi + 1)ae\sin\xi\mathrm{d}\xi}{\sqrt{a^{2}e^{2}\cosh^{2}\xi - a^{2}e^{2}}}} \nonumber \\
	& = & \sqrt{\dfrac{ma}{\alpha}}\int{\dfrac{a(e\cosh\xi + 1)ae\sin\xi\mathrm{d}\xi}{ae\sqrt{\cosh^{2}\xi - 1}}} \nonumber \\
	& = & \sqrt{\dfrac{ma^{3}}{\alpha}}\int{(e\cosh\xi + 1)\mathrm{d}\xi} \nonumber \\
	\mathrm{t} & = & \sqrt{\dfrac{ma^{3}}{\alpha}}(e\sinh\xi + \xi) \nonumber \\
\eea
...
\bea
	\vec{v}\wedge\vec{M} + \dfrac{\alpha}{r}\vec{r} & = & \begin{pmatrix} 0 \\ v_{\varphi} \\ 0 \end{pmatrix} \wedge \begin{pmatrix} 0 \\ 0 \\ M_{z} \end{pmatrix} + \begin{pmatrix} \alpha \\ 0 \\ 0 \end{pmatrix} \nonumber \\
	& = & \begin{pmatrix} v_{\varphi}M_{z} + \alpha \\ 0 \\ 0 \end{pmatrix}
\eea
...
\bea
	v_{\varphi}M_{z} + \alpha & = & \dfrac{M^{2}}{mr_{min}} + \alpha \nonumber \\
	& = & \dfrac{M^{2}(e - 1)}{mp} + \alpha \nonumber \\
	& = & \dfrac{M^{2}(e - 1)m\alpha}{mM^{2}} + \alpha \nonumber \\
	& = & (e - 1)\alpha + \alpha \nonumber \\
	& = & \alpha e
\eea

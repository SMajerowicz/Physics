...
\section{Mouvement lin\'eaire}\label{PAR:11}
...
\ee
qui s'\'ecrit en coordonn\'ees cart\'esiennes pour un unique degr\'{e} de libert\'{e} :
\be
...
\bea
	...
	\Leftrightarrow \dot{x}^{2} & = & \frac{2}{m}(E-U(x)) \nonumber \\
	\Leftrightarrow \dfrac{\mathrm{d}x}{\mathrm{dt}} & = & \sqrt{\frac{2}{m}(E-U(x))} \nonumber \\
	\Leftrightarrow t & = & \sqrt{\frac{m}{2}}\bigintsss{\dfrac{\mathrm{d}x}{\sqrt{E-U(x)}}} + cste \label{EQ:11_3}
\eea
...
Lors d'un mouvement, l'\'energie totale est toujours sup\'erieure \`a l'\'energie potentielle car l'\'energie cin\'etique ne peut \^etre n\'egative. Aussi le mouvement n'est possible que si $U(x)<E$.
...
Sur la figure (\ref{FIG:3_1}), la condition $U(x)<E$ implique que le mouvement n'est possible que sur les intervalles tels que $x\in\left[A\,;B\right]$ et $x\in\left[C\,;+\infty\right[$. Dans le premier cas, le mouvement est dit fini et oscillatoire. Dans le second cas, le mouvement est dit infini. Les points tels que :
\be
	U(x) = E \label{EQ:11_4}
\ee
sont les \emph{points d'arr\^et}. En effet, dans ce cas, l'\'energie cin\'etique du point mat\'eriel est nulle parce que sa vitesse l'est.
...
\bea
	...
	\Leftrightarrow \mathrm{T}(E) & = & \sqrt{2m}\bigintsss_{x_{1}(E)}^{x_{2}(E)}{\dfrac{\mathrm{d}x}{\sqrt{E-U(x)}}}\label{EQ:11_5}
\eea
qui d\'etermine la p\'eriode d'oscillation de la particule mat\'erielle en fonction de son \'energie totale.

\section{D\'efinition de l'\'energie potentielle en fonction de la p\'eriode des oscillations}\label{PAR:12}
...
\eea
La deuxi\`eme int\'egrale est en $\int_{U}^{\alpha}$ car en dehors de cet intervalle, $\int_{0}^{U}$ et $\int_{\alpha}^{E}$ sont ind\'efinie car $(E-U)$ et $(\alpha-E)$ sont respectivement n\'egatives.
...
\bea
	...
	& = & \mathrm{B}\left(\dfrac{1}{2},\dfrac{1}{2}\right) = \dfrac{\Gamma(1/2)\Gamma(1/2)}{\Gamma(1)} = \pi \nonumber
\eea
De fait :
\bea
...
\ee
De plus, si le champ d'\'energie potentielle est paire telle que $U(x) = U(-x)$ ou encore $x_{1}(U) = -x_{2}(U) = x(U)$, alors l'\'equation (\ref{EQ:12_1}) devient, puisque $x_{2}(U) - x_{1}(U) = 2x(U)$ :
\be
	x(U) = \dfrac{1}{2\pi\sqrt{2m}}\bigintsss_{0}^{U}\dfrac{\mathrm{T}(E)\mathrm{d}E}{\sqrt{U - E}} \label{EQ:12_2}
\ee

\section{Masse r\'eduite}\label{PAR:13}
...
\eea
et nous pouvons conclure en posant \emph{la masse r\'eduite} :
\be
...
\section{Mouvement dans un champ central}\label{PAR:14}
...
Par d\'efinition, voir \'equation (\ref{EQ:9_3}), le moment cin\'etique est :
\benn
...
\eenn
Ainsi, l'impulsion g\'en\'eralis\'ee d\'{e}finie par l'\'equation (\ref{EQ:7_5}) :
\benn
...
Nous r\'efl\'echissons d\'esormais à l'interpr\'etation g\'eom\'etrique de la loi pr\'ec\'edente (\ref{EQ:14_2}) en remarquant que l'expression $\frac{1}{2}\vec{r}\cdot\vec{r}\mathrm{d}\varphi$ repr\'{e}sente la surface form\'ee par les deux rayons vecteurs infiniment voisins et l'arc de la trajectoire de la figure (\ref{FIG:3_9}). En d\'esignant par $\mathrm{d}f$ cet \'el\'ement de surface, le moment cin\'etique de la particule devient :
\be
...
Pour obtenir la solution compl\`ete du mouvement d'une particule dans un champ central, utilisons les lois de conservation de l'\'energie, soit \'equation (\ref{EQ:6_1}), et du moment cin\'etique, soit (\'equation (\ref{EQ:9_3}). D'apr\`es la relation (\ref{EQ:14_2}), $\dot{\varphi} = \frac{M}{mr^{2}}$, donc l'\'energie peut s'\'ecrire comme :
\be
...
\bea
	M & = & mr^{2}\dot{\varphi} \nonumber \\
	\Leftrightarrow \mathrm{d}\varphi & = & \dfrac{M}{mr^{2}}\mathrm{dt} \nonumber
\eea
...
\eenn
peut se r\'e\'ecrire en identifiant $\frac{m}{2}\dot{r}^{2}$ comme l'\'energie cin\'etique radiale de la particule et nous obtenons :
\benn
...
\begin{itemize}
	\item $r \gg r_{max}$ alors le mouvement est infini
...
Pour le mouvement d'une particule ayant une moment cin\'etique non nul, la position $r=0$ est inatteignable car :
\benn
...
L'\'etude du champ central inversement proportionnel \`a $r$ est tr\`es important\footnote{Cela correspond \`a une force inversement proportionnel au carr\'e de la distance, voir l'\'equation (\ref{EQ:7_6}) donnant $F = \dfrac{\partial L}{\partial U}$} car il s'agit du champ gravitationnel, attractif, et du champ \'electrostatique de Coulomb, attractif ou r\'epulsif. Ainsi, d\'efinissons un champ d'attraction tel que :
\be
...
\benn
	\dfrac{\mathrm{d}U_{eff}(r)}{\mathrm{d}r} = 0 \Leftrightarrow \dfrac{\alpha}{r^{2}} - \dfrac{2M^{2}}{2mr^{3}} = 0 \Leftrightarrow \dfrac{\alpha}{r^{2}} = \dfrac{M^{2}}{mr^{3}} \Leftrightarrow r = \dfrac{M^{2}}{\alpha m}
\eenn
...
\begin{figure}[htb!]
	\begin{center}
		\begin{picture}(300,200)(0,0)
			...
			\put(140,10){\vector(1,0){185}}
			\put(126,8){$2a$}
			\put(215,60){\vector(-1,0){15}}
			\put(230,60){\vector(1,0){20}}
			\put(215,58){$ae$}
...
Le choix pr\'ec\'edemment fait pour avoir la constante d'int\'egration nulle correspond au point le plus proche du centre du champ et il correspond \`a $\varphi = 0$ d'apr\`es l'\'equation de la trajectoire (\ref{EQ:15_5}). Ce point est appel\'e le \emph{p\'erih\'elie} de l'orbite.
...
D'apr\`es la relation (\ref{EQ:15_4}), il est \'evident que si $-\frac{m\alpha^{2}}{2M^{2}} \le E < 0$ alors $e < 1$. L'orbite est alors une ellipse telle que montr\'ee sur la figure (\ref{FIG:3_11}). Le mouvement est fini et la trajectoire ferm\'ee. Dans ce cas pr\'ecis et en utilisant $\lvert E \rvert$, le grand demi-axe $a$ s'\'ecrit :
\bea
	a & = & \dfrac{p}{1 - e^{2}} = \dfrac{M^{2}}{m\alpha\left(1 - 1 - \dfrac{2EM^{2}}{m\alpha^{2}}\right)} = \dfrac{M^{2}}{\dfrac{2\lvert E \rvert M^{2}}{m\alpha}} \nonumber \\
	\Leftrightarrow a & = & \dfrac{\alpha}{2\lvert E \rvert} \label{EQ:15_6a}
\eea
...
\bea
	...
	\Leftrightarrow b & = & \dfrac{M}{\sqrt{2m\lvert E \rvert}} \label{EQ:15_6b}
\eea

De plus, la plus petite valeur de l'\'energie co\"incide avec l'\'energie cin\'etique nulle et par cons\'equent avec $(U_{eff})_{min}$, voir l'\'equation (\ref{EQ:15_3}). Dans ce cas, l'excentricit\'e $e$ de la section conique est \'egale \`a 1 et elle correspond \`a un cercle dont le rayon vaut $p$. Pour d'autres valeurs de l'\'energie telle que $E < 0$, les distances minimum et maximum au centre du champ central s'obtiennent en r\'esolvant l'\'equation $E = U_{eff}(r)$ qui s'\'ecrit :
\benn
...
\be
	...
	\end{cases}
\ee
avec $r_{min}$ le p\'erih\'elie de la trajectoire.

Dans notre cas qui nous occupe, il est aussi int\'eressant de d\'eterminer la p\'eriode de r\'evolution $T$ sur l'orbite de la particule. La loi de conservation du mouvement associ\'ee \`a la loi des aires (\ref{EQ:14_3}) permet d'\'ecrire :
\bea
...
\ee
Au-del\`a du fait que la p\'eriode ne d\'epende que de l'\'energie de la particule, nous retrouvons la troisi\`eme loi de Kepler \'enonc\'ee dans l'\'equation (\ref{EQ:10_KEPLER}).
...
Pour $E \ge 0$, le mouvement est infini et plus pr\'ecis\'ement pour $E > 0$, l'excentricit\'e $e > 1$ et la trajectoire est alors une hyperbole, voir la figure (\ref{FIG:3_12}). Dans ce cas, le p\'erih\'{e}lie est :
\be
...
Dans le plan de la trajectoire, en coordonn\'ees cart\'esiennes telles que les axes $x$ et $y$ suivent respectivement le grand et le petit demi-axes de l'ellipse, alors :
\benn
	\begin{cases}
		x = r\cos\varphi \\
		y = r\sin\varphi
...
\benn
	\mathrm{t} = \bigintsss{\dfrac{\mathrm{d}r}{\sqrt{\dfrac{2}{m}\left(E + \dfrac{\alpha}{r}\right) - \dfrac{M^{2}}{m^{2}r^{2}}}}} =  \sqrt{\dfrac{m}{2E}}\bigintsss{\dfrac{r\mathrm{d}r}{\sqrt{r^{2} + \dfrac{\alpha}{E}r - \dfrac{M^{2}}{2mE}}}}
\eenn
...
\bea
	...
	\Leftrightarrow \mathrm{t} & = & \sqrt{\dfrac{ma^{3}}{\alpha}}(e\sinh\xi - \xi) \nonumber
\eea
...
\ee
avec $\alpha > 0$. Alors par analogie, l'\'equation (\ref{EQ:14_8}) peut s'\'ecrire ainsi :
\benn
	U_{eff}(r) = \dfrac{\alpha}{r} + \dfrac{M^{2}}{2mr^{2}}
\eenn
et une illustration est partag\'ee sur la figure (\ref{FIG:3_13a}).
...
\ee
car $a = \frac{\alpha}{2E}$.
L'\'equation (\ref{EQ:14_6}) se d\'eveloppe en :
\benn
...
Cherchons une int\'egrale premi\`ere, i.e. constante dans le temps, sp\'ecifique \`a ce type de champ en $\frac{\alpha}{r}$ avec $\alpha\in\mathbb{R}$ Nous faisons d'abord la remarque suivante :
\bea
	\dfrac{\mathrm{d}}{\mathrm{dt}}\left(\vec{v}\wedge\vec{M} + \dfrac{\alpha}{r}\vec{r}\right) & = & \dot{\vec{v}}\wedge\vec{M} + \vec{v}\wedge\dot{\vec{M}} + \dfrac{\alpha}{r}\dot{\vec{r}} - \dfrac{\alpha}{r^{3}}\vec{r}(\vec{v}\cdot\vec{r}) \nonumber \\
	& = & \dot{\vec{v}}\wedge\vec{M} + \dfrac{\alpha}{r}\dot{\vec{r}} - \dfrac{\alpha}{r^{3}}\vec{r}(\vec{v}\cdot\vec{r}) \nonumber
\eea
car il y a toujours conservation du moment cin\'etique et donc $\vec{\dot{M}} = \vec{0}$. De plus $\vec{M} = m\vec{r}\wedge\vec{v}$ donc :
\benn
	\dfrac{\mathrm{d}}{\mathrm{dt}}\left(\vec{v}\wedge\vec{M} + \dfrac{\alpha}{r}\vec{r}\right)  = m(\dot{\vec{v}}\cdot\vec{v})\vec{r} - m(\dot{\vec{v}}\cdot\vec{r})\vec{v} + \dfrac{\alpha}{r}\dot{\vec{r}} - \dfrac{\alpha}{r^{3}}\vec{r}(\vec{v}\cdot\vec{r})
\eenn
En revenant à l'\'equation du mouvement (\ref{EQ:5_3}) :
\benn
	m\dot{\vec{v}} = -\dfrac{\partial U}{\partial\vec{r}} = \dfrac{\alpha}{r^{3}}\vec{r}
\eenn
La quantit\'e :
\bea
	m(\dot{\vec{v}}\cdot\vec{v})\vec{r} - m(\dot{\vec{v}}\cdot\vec{r})\vec{v} + \dfrac{\alpha}{r}\dot{\vec{r}} - \dfrac{\alpha}{r^{3}}\vec{r}(\vec{v}\cdot\vec{r}) & = & m(\dot{\vec{v}}\cdot\vec{v})\vec{r} - m(\dot{\vec{v}}\cdot\vec{r})\vec{v} + \dfrac{\alpha}{r}\dot{\vec{r}} - m\dot{\vec{v}}(\vec{v}\cdot\vec{r}) \nonumber \\
	& = & m(\dot{\vec{v}}\cdot\vec{v})\vec{r} - m\dot{\vec{v}}(\vec{v}\cdot\vec{r}) - (m\dot{\vec{v}}\cdot\vec{r})\vec{v} + \dfrac{\alpha}{r}\dot{\vec{r}} \nonumber \\
	& = & m(\dot{\vec{v}}\cdot\vec{v})\vec{r} - m(\dot{\vec{v}}\cdot\vec{v})\vec{r} - \dfrac{\alpha}{r}\vec{v} + \dfrac{\alpha}{r}\dot{\vec{r}} \nonumber \\
	& = & \vec{0} \nonumber
\eea
Ainsi le vecteur :
\be
...
\bea
	...
	& = & \alpha e \nonumber
\eea
en prenant pour r\'ef\'erence pour la valeur du param\`etre $p$ la relation (\ref{EQ:15_15}). Le vecteur d\'efini en (\ref{EQ:15_17}) est donc constant en norme qui est \'egale \`a $\alpha e$. L'int\'egrale premi\`ere (\ref{EQ:15_17}) comme les lois de conservation de l'\'energie et du moment cin\'etique est une fonction uniforme de l'\'etat de la particule, position et vitesse. L'apparition de l'int\'egrale suppl\'ementaire (\ref{EQ:15_17}) est due à la d\'eg\'en\'erescence du mouvement, \'etudi\'e au paragraphe (\ref{PAR:52}).

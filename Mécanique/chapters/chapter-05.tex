...
\bea
	b^{2} & = & \frac{1}{\xi}\left[\frac{\epsilon}{2} + \sqrt{\left(\frac{\alpha f}{6m\omega_{0}^{3}}\right)^{2} - \lambda^{2}}\right] \label{EQ:29_13} \\
	b^{2} & = & \frac{1}{\xi}\left[\frac{\epsilon}{2} - \sqrt{\left(\frac{\alpha f}{6m\omega_{0}^{3}}\right)^{2} - \lambda^{2}}\right] \label{EQ:29_14}
\eea

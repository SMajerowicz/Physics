...
\begin{figure}[htb!]
		...
		\caption{Amplitude $b$ de la solution pr\'{e}c\'{e}dente avec des valeurs de l'amplitude de la force ext\'{e}rieure comprise entre 0 et 0.01 et $\lambda = 0.01$, $\omega_{0} = 0.1$, $x = 0.05$ et $m = 0.25$}\label{FIG:5_29}
        \end{center}
\end{figure}

...
\benn
	x_{1}(\mathrm{t}) = \mu^{\mathrm{t}/T}\Pi_{1}(\mathrm{t})\text{, }x_{2}(\mathrm{t}) = \Pi_{2}(\mathrm{t})/\mu^{\mathrm{t}/T} = \mu^{-\mathrm{t}/T}\Pi_{2}(\mathrm{t})\ref{EQ:27_6}
\eenn
...
\section {Oscillations anharmoniques}
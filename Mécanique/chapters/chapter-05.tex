...
\eenn
et comme $f^{2} = f_{1}^{2}\cos^{2}(\omega\mathrm{t}) + f_{2}^{2}\sin^{2}(\omega\mathrm{t}) + 2f_{1}f_{2}\cos(\omega\mathrm{t})\sin(\omega\mathrm{t})$ alors $f^{2} = f_{1}^{2}/2 + f_{2}^{2}/2$. L'\'{e}nergie potentielle effective s'exprime donc ainsi :
\be

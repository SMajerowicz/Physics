...
\subsection{Cas d'une force ext\'{e}rieure dont la fr\'{e}quence diff\`{e}re largement de $\omega_{0}$ : $\gamma \approxeq \omega_{0}/2$}

Observons maintenant ce qui arrive dans le cas o\`{u} la fr\'{e}quence de la force ext\'{e}rieure diff\`{e}re sensiblement de $\omega_{0}$. Nous choisissons ici $\gamma \approxeq \omega_{0}/2$ ou encore $\gamma = \omega_{0}/2 + \epsilon$.

Dans l'approximation lin\'{e}aire, i.e. celle du premier ordre, \'{e}tudi\'{e}e dans le paragraph (\ref{PAR:22}) et en appliquant la solution (\ref{EQ:22_4}) sachant que $\omega_{0}^{2} - \gamma^{2} = \omega_{0}^{2} - \omega_{0}^{2}/4 - \epsilon^{2} + 2\omega_{0}\epsilon \approxeq 3\omega_{0}^{2}/4$ en premi\`{e}re approximation, nous avons :
\benn
...
\subsection{Cas d'une force ext\'{e}rieure dont la fr\'{e}quence diff\`{e}re largement de $\omega_{0}$ : $\gamma \approxeq 2\omega_{0}$}

En utilisant la m\^{e}me m\'{e}thodologie que pr\'{e}c\'{e}demment, nous avons $\omega_{0}^{2} - \gamma^{2}= \omega_{0}^{2} - 4\omega_{0}^{2} - \epsilon^{2} - 4\omega_{0}\epsilon \approxeq -3\omega_{0}^{2}$ en premi\`{e}re approximation. Soit en appliquant la solution (\ref{EQ:22_4}) :
\benn

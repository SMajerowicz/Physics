...
\benn
	x_{1}(\mathrm{t}) = \mu^{\mathrm{t}/T}\Pi_{1}(\mathrm{t})\text{, }x_{2}(\mathrm{t}) = \Pi_{2}(\mathrm{t})/\mu^{\mathrm{t}/T} = \mu^{-\mathrm{t}/T}\Pi_{2}(\mathrm{t})
\eenn
...
\eea
En n\'{e}gligeant les termes en $\epsilon^{2}$, nous avons $\alpha^{2} \approx \omega_{0}^{2} + \omega_{0}\epsilon$ et nous pouvons porsuivre telle que :
\bea
	& & ...
\eea

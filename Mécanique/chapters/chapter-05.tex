...
Ici, nous allons consid\'{e}rer le mouvement d'une particule soumise simultan\'{e}ment \`{a} l'action d'un champ constant $U$ et d'une force ext\'{e}rieure d\'{e}finie telle que :
\be
...
\ee
$\xi(\mathrm{t})$ \'{e}tant une oscillation, sa valeur moyenne calcul\'{e}e sur sa p\'{e}riode $2\pi/\omega$ est nulle, alors que $X(\mathrm{t})$ aura vari\'{e} faiblement. \`{A} partir de cette remarque, nous pouvons d\'{e}duire que $\overline{x} = \overline{X}$, i.e. $X$ d\'{e}crit le mouvement non perturb\'{e} moyen de la particule par rapport aux oscillations rapides. La m\'{e}thode de d\'{e}termination de l'\'{e}quation du mouvement a \'{e}t\'{e} d\'{e}crite par Piotr Kapitsa en 1951.

En utilisation $x(\mathrm{t})$ d\'{e}finie par la relation (\ref{EQ:30_3}) dans l'\'{e}quation (\ref{EQ:30_2}), nous \'{e}crivons :
\benn
...
\ee
Le second membre se compose de deux parties distinctes :
\begin{itemize}
...
\eenn
qui donne par int\'{e}gration double et en supposant comme nulle les constantes d'int\'{e}gration, nous arrivons \`{a} :
\bea
...
$\overline{\dot{\xi}^{2}}$ est justement l'expression de l'\'{e}nergie cin\'{e}tique moyenne du mouvement oscillatoire, qui, par d\'{e}finition, est constante par rapport au temps. Le mouvement moyen de la particule par rapport aux oscillations s'effectue comme si, en plus du champ $U$, agissait un champ suppl\'{e}mentaire constant et d\'{e}pendant du carr\'{e} de l'amplitude d'un champ variable.
